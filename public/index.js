...
// // Improved script loading with event listener
...
//         loadingBar.style.display = "none";
//     }).catch((message) => {
//         // Logging error to console instead of alert
...
// // setInterval(() => {
// //     var command = document.getElementById("insert").innerHTML;
// //     if (command) {
// //         mygi.SendMessage('Character', command);
// //         document.getElementById("insert").innerHTML = "";
// //     }
// // }, 100);
